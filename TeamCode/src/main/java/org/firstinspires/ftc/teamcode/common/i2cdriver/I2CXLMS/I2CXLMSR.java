package org.firstinspires.ftc.teamcode.common.i2cdriver.I2CXLMS;
...
public class I2CXLMSR extends I2cDeviceSynchDevice<I2cDeviceSynch>
{
    ...
    public I2CXLMSR(I2cDeviceSynch deviceClient)
    {
    ...
    protected I2CXLMSR(I2cDeviceSynch i2cDeviceSynch, boolean deviceClientIsOwned)
    {
